...
function AddDisciplinaModal() {
  const {newDisciplina, setNewDisciplina, resetNewDisciplina, loading, createDisciplina} = gestorAuth()

  //Envia os dados para criar disciplina nova
  const handleSubmit = (e) => {
    e.preventDefault();
    createDisciplina();
    document.getElementById("addDisciplinaModal").close();
  }

  return (
    <dialog id='addDisciplinaModal' className='modal'>
