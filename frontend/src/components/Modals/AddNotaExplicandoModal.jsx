...
function AddNotaExplicandoModal({id_avalFutura}) {
  const {newNota, setNewNota, resetNewNota, loading, createNota, explicandos, disciplinas, getAllDisciplinas} = gestorAuth()
  ...
  const handleSubmit = (e) => {
    ...
    document.getElementById("addNotaExplicandoModal").close();
  }

  return (
    <dialog id='addNotaExplicandoModal' className='modal'>
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <div className='modal-action'>
            ...
            <button type='submit' className='btn btn-primary min-w-30'
              disabled={!newNota.data_avaliacao || !newNota.descricao || !newNota.valor || !newNota.id_disciplina || loading }>
...
export default AddNotaExplicandoModal
