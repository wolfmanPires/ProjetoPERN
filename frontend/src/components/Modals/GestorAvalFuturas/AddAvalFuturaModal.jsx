...
function AddAvalFuturaModal() {
  ...
  const handleSubmit = (e) => {
    ...
    createAvalFutura();
    document.getElementById("addAvalFuturaModal").close();
  }

  return (
    <dialog id='addAvalFuturaModal' className='modal'>
...
export default AddAvalFuturaModal
