...
function EditAvalFutura() {
  const {newAvalFutura, setNewAvalFutura, resetNewAvalFutura, loading, editAvalFutura, editIDAvalFutura, explicandos, disciplinas} = gestorAuth()

  //Envia os dados para editar avaliacao futura nova
  const handleSubmit = (e) => {
    ...
    editAvalFutura(editIDAvalFutura);
    document.getElementById("editAvalFuturaModal").close();
  }

  return (
    <dialog id='editAvalFuturaModal' className='modal'>
      <div className='modal-box'>
        ...
        {/* Header do Modal */}
        <h3 className='font-bold text-xl mb-4'> Editar Nota </h3>

        <form onSubmit={handleSubmit} className='space-y-6'>
          <div className='grid gap-6'>
            <h2 className='font-semibold text-lg'> Dados da Avaliação Futura </h2>
            ...
            <div className='form-control'>
              ...
              <Select options={explicandos.map(e => ({
                ...
                value={explicandos.map(e => ({
                  value: e.id_explicando,
                  label: `${e.nome}`
                })).find(op => op.value === newAvalFutura.id_explicando)}
                onChange={(option) => setNewAvalFutura({
                  ...newAvalFutura,
          ...
          <div className='modal-action'>
            ...
            <button type='submit' className='btn btn-primary min-w-30'
              disabled={!newAvalFutura.data || !newAvalFutura.descricao || !newAvalFutura.id_explicando || !newAvalFutura.id_disciplina || loading }>
