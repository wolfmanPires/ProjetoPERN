...
function AddExplicadorModal() {
  const {newUtilizador, newExplicador, setNewUtilizador, setNewExplicador, resetNewUtilizador, resetNewExplicador, loading, createExplicador} = gestorAuth()
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    createExplicador();
    document.getElementById("addExplicadorModal").close();
  }

  return (
    <dialog id='addExplicadorModal' className='modal'>
      <div className='modal-box'>
        ...
        {/* Header do Modal */}
        <h3 className='font-bold text-xl mb-4'> Adicionar Novo Explicador </h3>
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <div className='modal-action'>
            ...
            <button type='submit' className='btn btn-primary min-w-30'
              disabled={!newUtilizador.nome || !newUtilizador.email || !newUtilizador.telemovel || !newUtilizador.password || !newExplicador.especialidades || !newExplicador.habilitacoes || loading }>
...
export default AddExplicadorModal
