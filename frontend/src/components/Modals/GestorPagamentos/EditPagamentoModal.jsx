...
function EditPagamentoModal() {
  const {newPagamento, setNewPagamento, resetNewPagamento, loading, editPagamento, editIDpagamento, utilizadores} = gestorAuth()
  ...
  const handleSubmit = (e) => {
    ...
    editPagamento(editIDpagamento);
    document.getElementById("editPagamentoModal").close();
  }

  return (
    <dialog id='editPagamentoModal' className='modal'>
      <div className='modal-box'>
        ...
        {/* Header do Modal */}
        <h3 className='font-bold text-xl mb-4'> Editar Pagamento </h3>
...
export default EditPagamentoModal
