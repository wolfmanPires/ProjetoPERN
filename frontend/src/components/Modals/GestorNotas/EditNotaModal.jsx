...
function EditNotaModal() {
  const {newNota, setNewNota, resetNewNota, loading, editNota, editIDnota, explicandos, disciplinas} = gestorAuth()
  ...
  const handleSubmit = (e) => {
    ...
    editNota(editIDnota);
    document.getElementById("editNotaModal").close();
  }

  return (
    <dialog id='editNotaModal' className='modal'>
