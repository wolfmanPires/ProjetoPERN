...
function AddExplicacaoModal() {
  const {newExplicacao, setNewExplicacao, resetNewExplicacao, loading, createExplicacao, explicacoes, explicadores, explicandos, disciplinas} = gestorAuth()
  ...
  const handleSubmit = (e) => {
    ...
    createExplicacao();
    document.getElementById("addExplicacaoModal").close();
  }

  return (
    <dialog id='addExplicacaoModal' className='modal'>
      <div className='modal-box'>
        ...
        {/* Header do Modal */}
        <h3 className='font-bold text-xl mb-4'> Adicionar Explicação </h3>
...
export default AddExplicacaoModal
