...
function EditExplicandoModal() {
  const {newUtilizador, newExplicando, setNewUtilizador, setNewExplicando, resetNewUtilizador, resetNewExplicando, loading, editExplicando, editIDutilizador, editIDexplicando} = gestorAuth()
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    editExplicando(editIDutilizador,editIDexplicando);
    document.getElementById("editExplicandoModal").close();
  }

  return (
    <dialog id='editExplicandoModal' className='modal'>
      <div className='modal-box'>
        ...
        {/* Header do Modal */}
        <h3 className='font-bold text-xl mb-4'> Editar Explicando - {newUtilizador.nome} </h3>
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <div className='modal-action'>
            ...
            <button type='submit' className='btn btn-primary min-w-30'
              disabled={!newUtilizador.nome || !newUtilizador.email || !newUtilizador.telemovel || !newExplicando.dificuldades || !newExplicando.ano || loading }>
...
export default EditExplicandoModal
