...
function AddGestorModal() {
  const {newUtilizador, setNewUtilizador, resetNewUtilizador, loading, createGestor} = gestorAuth()
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    createGestor();
    document.getElementById("addGestorModal").close();
  }

  return (
    <dialog id='addGestorModal' className='modal'>
      <div className='modal-box'>
        ...
        {/* Header do Modal */}
        <h3 className='font-bold text-xl mb-4'> Adicionar Novo Gestor </h3>
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <div className='modal-action'>
            ...
            <button type='submit' className='btn btn-primary min-w-30'
              disabled={!newUtilizador.nome || !newUtilizador.email || !newUtilizador.telemovel || !newUtilizador.password || loading }>
